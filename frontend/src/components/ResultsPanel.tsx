...
export default function ResultsPanel({ report }: ResultsPanelProps) {
  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-4 py-5 sm:px-6 sm:py-7 space-y-4">
      <article className="rounded-xl border border-white/10 bg-[var(--bg-surface)] p-4 enter-card">
      ...
      <section className="grid gap-3 sm:grid-cols-3">
        {report.unified_impact.headline_stats.slice(0, 3).map((stat) => (
          <article key={stat.label} className="rounded-xl border border-white/10 bg-white/[0.05] p-3 enter-card">
      ...
      <section className="rounded-xl border border-white/10 bg-[var(--bg-surface)] p-4 enter-card">
